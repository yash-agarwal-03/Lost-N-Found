...
const AdminControl=()=>{
    ...
    return (
        <div className="relative">
          {(showAdminPopup && ( //if admin prompt is True
          ...
          <div className="flex justify-center gap-4 mt-2">
            <button
            style={{ backgroundColor: "blue", color: "white" ,margin : "0 10px", transition:"ease-in-out 0.3s" }}
              onMouseEnter={(e) =>
            ...
            <button
              style={{ backgroundColor: "red", color: "white" ,margin : "0 10px", transition:"ease-in-out 0.3s" }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.boxShadow = "1px 1px 5px #000")
                }
                onMouseLeave={(e) =>
